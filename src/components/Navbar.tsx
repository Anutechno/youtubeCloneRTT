...
import { getSearchPageVideo } from "../store/reducers/getSearchPageVideos";
            ...
            <div className='flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky top-0 -z-50'>
                ...
                <div className="flex items-center justify-center gap-5">
                    ...
                    <div className="flex gap-5 items-center text-xl">
                        ...
                        <img
                            src='https://media.istockphoto.com/id/1392736060/photo/red-metallic-letter-a-with-light-bulbs.jpg?s=1024x1024&w=is&k=20&c=ZIT2lOTDXZeXluUgnBhkNVncUMxP-zEZw5FlZzKKiGU='
                            alt='logo'
