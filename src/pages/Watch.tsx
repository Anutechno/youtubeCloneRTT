              ...
              <div style={{ maxWidth: "800px" }}>
                <div>
                  <iframe
                    ...
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;piture-in-piture"
                    allowFullScreen
                  ></iframe>
                  <div className="mt-5">
                    ...
                    <div className="flex justify-between mt-1">
                      <div className="text-sm text-gray-400">
                        <span className="after:content-['.'] after:mt-1">
                          {currentPlaying.videoViews}views
                        </span>
                        <span className="">{currentPlaying.videoAge}</span>
                      </div>
                    ...
                    <div className="flex gap-4 flex-col border-solid border-gray-400 border-2 my-5 pb-3 border-1-transparent border-r-transparent ">
                      <div className="flex items-center gap-5 mr-5 mt-4 ">
                        ...
                        <div>
                          <button className="uppercase bg-red-600 rounded-sm p-2 text-sm tracking-wideer ">
                            subscribe
                          </button>
                        </div>
                      </div>
                      <div className={`${!showMoreStatus ? "max-h-16 overflow-hidden" : ""
                        }text-sm w-11/12`}>
                        <pre
                          style={{
